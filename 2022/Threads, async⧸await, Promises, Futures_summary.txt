...
• The speaker's reactions to his sons' behavior, including frustration and embarrassment
...
• Discussion of ThreadMod and its relation to multi-level threading
...
• Implementing asynchrony in Hubris using a series of synchronous tasks
• Discussion of Unix design and its isolation of asynchrony
...
• Comparison with other operating systems, including VaxVMS, Windows NT, and Solaris
• Examination of the concept of I/O completion ports and their role in asynchronous I/O operations
• The limitations of the UNIX system interface, particularly with regards to blocking system calls
...
• The experience of implementing the USDT interface for Rust, specifically with regards to the D-Trace system
• Challenges with debugging async/await code in D-Trace
• The limitations of using thread IDs in debugging asynchronous code
• The importance of stack backtraces in understanding code execution
...
• Emergent behavior in Erlang systems
• Discussion of the challenges and limitations of Erlang
• Critique of RabbitMQ and its reliability
• Discussion of the tension between emergent behavior and system reliability
...
• The speaker explains that Zig's philosophy is to make things explicit and give the programmer control
• Async/await in Zig is implemented using stack frames and coroutines
• Debuggability is a design center for Zig, aiming to make it easier to understand what's happening
...
• Experience with Twisted and Node.js, including issues with emergent behavior and accidental blocking
• Sharing of personal anecdotes about writing servers, including a project using the shoutcast protocol
...
• Challenges with blocking write syscalls and concurrent connections
...
• Discussion of the HHVM (HipHop Virtual Machine) project and its approach to concurrency
...
• Comparison of different concurrency models, including asyncIO, G-unicorn, and Trolleus
• Explanation of the Trolleus project and its use of exception handling for concurrency
• Personal anecdote about building a production system using Trolleus
• Comparison of Trolleus with other concurrency models and hacks
...
• Better tools and languages available today (Rust, Zig, Go)
...
• Discussion of ePoll and event ports as useful models for async interfaces
• Introduction of IOU ring, an alternate syscall layer that allows shared memory between kernel and user space
...
• History of Python's async support, including Stackless Python and the development of Ventlet and G event
...
• Preview of upcoming conversation with Sean Silcoff

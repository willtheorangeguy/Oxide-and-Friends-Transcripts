• Measurement of backplate cabling between switch and compute sled using TDR
...
• Importance of modelling and simulation in system design
• Challenges of dealing with insertion loss and signal degradation in PCB design
• Role of software in system design, including ANSIs and Ennis
• Difficulties of via and cross-sections in PCB design
...
• Comparison of current software limitations to older systems (e.g. Polaris)
• Difficulty in routing via and traces in 3D geometry
• Challenges in simulating and debugging complex electromagnetic interactions
• Importance of accurate modelling and simulation in high-speed digital design
...
• Importance of considering frequency-dependent loss and interconnect behaviour
...
• PAM 4 and PAM 16 signalling and their impact on eye diagrams
...
• TDR (Time Domain Refractometry) explained
...
• Reference to a previous story about getting the Chelsea NIC up and running
• Description of issues with getting the 100 Gb/s link to work, with jitter being a major problem
• Discussion of expensive equipment (Lab master scope) used to measure jitter
...
• Equalization (COLE, DFE) used to recover signal from poor channel conditions
...
• Introduction to the GL scope client, an open source application for oscilloscopes that provides a user interface and front end
• Explanation of the GL scope client's architecture and features, including its ability to connect to multiple oscilloscope models and load waveform data from files
• Discussion of the importance of open standards and APIs for equipment, and how this prevents vendor lock-in and bad behaviour
...
• Specific data example: quad serial gigabit media independent interface (IS-GMII) with 4 lanes of up to gigabit data
• Filter blocks for recovering clock, threshold analog waveform, decoding 8b10b, and outputting 4 additional streams of 8b10b symbols
...
• Discussing a decoded that converts 8-10 B objects to Ethernet frame objects
...
• ENID (electroless nickel immersion gold) process
• Service roughness and its impact on PCBs
• Resistance vs. dielectric losses in PCBs
• Fibre weave effect and its impact on signal integrity
• Simulation and measurement of PCB losses and fibre weave effect
• Importance of surface roughness and adhesion in PCBs
• Impact of PCB losses on high-speed digital design (jitter, skew, etc.)
• Developing a custom backplate with precise control over components

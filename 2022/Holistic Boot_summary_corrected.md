...
• Experiences with unreliable computers and firmware issues at Sun and Joint
...
• Operators often accept suboptimal behaviour as normal
...
• The concept of training Simms (Dual In-Line Memory Modules) and how it affects the boot time of the system
...
• Lack of documentation and understanding of firmware behaviour
...
• Discussing the limitations of the Spore, a 32 Meg payload device, and the challenges of fitting enough operating system to enable sophisticated operations
...
• Boot loading and initialization of x86 architecture
...
• Use of Include Bytes to include the kernel image in the foible executable
...
• Introduction of the frap mechanism and its use in firmware and drivers
• Enthusiasm for a new feature in a language that allows inclusion of file system data in the compile step
• Explanation of the Pi cohost bootloader and its special-purpose design
• Potential for using the Pi cohost bootloader on another system

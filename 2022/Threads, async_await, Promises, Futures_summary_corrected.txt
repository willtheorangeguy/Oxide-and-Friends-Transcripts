...
• Conway's Law and its relevance to synchrony
...
• Discussion of Polaris' and other systems' handling of blocking system calls
• Comparison of POSIX signal handling in Polaris, Slaters, and other systems
• Criticism of UNIX design and its influence on modern async systems
• Examination of the Go runtime's use of timer-based signalling
...
• Synchrony and debuggability issues in Node.js and futures
...
• Discussion of emergent behaviour in complex systems
• React and RabbitMQ examples of distributed systems
• Debugging issues with RabbitMQ and its limitations
• Single wait concept in Big programming language
• Big's approach to async programming and coroutines
• Debugability as a design centre for Big
...
• Emergent behaviour and production bugs in asynchronous systems
• Personal anecdotes of learning asynchronous programming through writing servers for specific projects (e.g. Sh outcast protocol, Internet radio stations)
...
• Big concurrency story and comparisons to existing concurrency models like unicorn
• Trollies: a Python library that used the exception model for async IO
• Quay.io: a private Docker registry with a build manager that used Trollies
• Abusing the exception model for async IO is considered an "async hack"
• The system built with Trollies was considered a nightmare to work with
...
• History of Python's async programming models, including Stackless Python and Event
...
• Upcoming guest Sean Wilcox to discuss the book "Losing the Signal" about RIM's rise and fall

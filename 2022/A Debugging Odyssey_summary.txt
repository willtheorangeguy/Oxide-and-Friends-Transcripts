...
• Touching on the impact of Dave's lack of rigor in documenting the issue and the team's response to it
...
• Use of various tools and approaches, including libumem and Gemalloc, without clear evidence of their relevance
...
• Using MDB's typedef command to describe data structures in C code
...
• Discussing the process of using DTrace to instrument and record information about the system's behavior.
...
• A bug was found in the GCC Go compiler from 10 years ago related to Solaris.
...
• Review of a previous conversation about the issue, where the speaker expressed concern about the "unsafety" of the program
...
• Review of the steps taken to investigate and reproduce the issue, including writing a C program to test the behavior
• Confirmation that the issue was not being saved correctly, leading to a solution to fix the problem
• Difficulty in reproducing a specific problem with DTrace
• Use of "raise" and its effectiveness in triggering specific failures
• Instruction tracing and its usefulness in debugging
• Discussion of DTrace's Turing completeness and ability to implement additional features through "raise"
• Challenges and complexities of debugging with DTrace, particularly with rampant inlining and nested inlining
...
• The value of combining DWARF and TWARF to gain access to arguments and other information

...
• Consideration of using ZFS and a distributed storage layer, or a "mix" architecture
...
• The culture and humour of the Oxide team, including the naming of data centres after pet food brands
...
• Writing extensive tests, including unit tests, integration tests, and fine-grained downstairs behaviour based testing
...
• The importance of deliberate back pressure in distributed systems
• God's own back pressure (unpredictable and inconsistent back pressure)
• Designing explicit back pressure in the system
• The ZFS right throttle and write caching
• The volatile write cache and flush behaviour
...
• Use of ZFS for copyright snapshooting, extent management, and guarantees
...
• The impact of Matt's contributions to the project's organization and structure
• The importance of communication and collaboration among team members with different backgrounds and codebases
• The success of leveraging Rust across multiple systems and projects (Probes, Omicron, Crucible, Hubris)

• Discussion of Oxide's remote work setup and Bryan Can trill's morning routine
• Adam Levinthal's European background and its relevance to Oxide
• Joking about German listeners and airport security
• Bryan Can trill's apology to Germany
• Oxide's open-sourced software and its benefits
• Discussion of "Requests for Discussion" (RFPs) and their importance to Oxide
• Adam Levinthal's "big reveal" of the topic, which is the RFP mechanism and its role in Oxide's decision-making process
...
• The PARC process at Sun is mentioned as a precursor to the RFT process, with Bryan describing it as valuable for forcing engineers to document their ideas and identify issues
• The PARC process is also described as time-consuming and bureaucratic, with approval or rejection being the only outcomes
...
• Retrospective on the implementation of RFPs at Joint and experiences with the format
...
• Comparison of RFP systems at Joy ant and Delphi
• Importance of discoverability and searchability
• Use of Markdown and Acidic for RFPs
• Challenges of rendering Markdown documents locally
• Evolution of RFP system and current goals
• Discussion of Markdown and Acidic as documentation formats
• Acidic's strengths and weaknesses compared to Markdown
• Robert Mustachio's experience with Acidic and its features
• Bryan Can trill's realization about the widespread use of Markdown
• Statistics on the number of RFDs and words contributed to them
• Robert Mustachio's prolific contribution to RFDs
• Adam Levinthal's high number of collaborators on RFDs
...
• Use of Acidic as a documentation format and its benefits
• Transition from Markdown to Acidic and the reasoning behind it
...
• Pain points of searching RFTs, including no full text search and relying on manual grew searches
...
• Discussion of Acidic and its use across various systems
• Challenges with using Acidic, including lack of native libraries and assumptions about processing
• Development of a React renderer for Acidic to improve interactivity and accessibility
• Creation of an intermediary format for Acidic to improve performance and dynamic documentation
• Benefits of using Acidic for documentation, including cross-linking and GitHub integration
...
• Implementing a system to associate GitHub comments with specific lines in Acidic documents
...
• Introducing permission and access control to the RFD site, allowing for more granular control over who can access specific RFPs and discussions
...
• Augustus is the only consumer of per-gender generated CLI's that the speaker is aware of
...
• The system has enabled fine-grained permissions and has become essential to Ox nard's operations.

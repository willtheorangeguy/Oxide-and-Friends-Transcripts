...
• The company rebooted their most important data centre, U.S. East 1
...
• Mention of a bespoke options parser and criticism from Mr. Clue lo
...
• Reference to a Jira issue about in-band signalling and colours in Jira text
...
• Recollection of a past incident where the entire data centre was rebooted due to human error and brittle command
• Lighthearted digression about a rusty scalpel and preschool ride-alongs
...
• Lack of knowledge about the system's behaviour and the potential outcomes
...
• Observations of system behaviour during the "Sandy Bridge era"
• Discussion of the "booster" process, including its role as a TFTP server and its resource limitations
• Examination of the system's resource constraints, including low DRAM and CPU limitations
• Implications of the system's architecture on its performance and behaviour under various load conditions
...
• PMI (Intelligent Platform Management Interface) and manual rebooting
• BIOS issues with timed out TFTP (Trivial File Transfer Protocol) connections
• Broadcom bug
• Net Extreme 2 (NIC) and its closed driver
...
• Recalling a presentation by Mark, Brick, and Steve on a Heroku outage that lasted 66 hours
...
• Description of the "booster" system and its role in the recovery process
...
• Discussion about a experience of huddling together in a small space
...
• Avoiding speculation and rumours through transparent updates
...
• IONS fracture
• Tensions leading to IONS fracture
...
• Safety point regarding command failure and potential destructive behaviour
...
• The command is a strongly typed interface with a limited subset of valid host names, which can lead to safety issues.
...
• Using YubiKey and certs in the UEFI chain store
• pixie and its complexities
...
• Paste lance and Intel's involvement
...
• Ends being treated as strings rather than separate types
...
• Importance of in-band signalling
...
• The speaker and others have learned from experiences, especially a major incident that could have been much worse.
...
• The company will return to normal operations when the data centre is back up.

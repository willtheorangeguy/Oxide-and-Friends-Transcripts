...
• Explanation of Helios as a distribution of Lumos, similar to Ubuntu being a distribution of Linux
• Clarification of the relationship between Helios and Lumos, and the concept of distributions
• Discussion of the engineering complexity involved in creating a distribution, particularly with Linux
• Explanation of the integration of system libraries and commands in Lumos and Helios
• Building a custom operating system from existing components
• External dependencies and packages required for the OS
• History and evolution of the OS, including influences from OpenIndiana and OmniOS
• Challenges of building a custom OS, including bootstrapping and dependency management
• Rostup support and crate maintenance
...
• Using a small bootloader written in Rust to load the Illumos kernel
...
• Helios is designed to run on commodity hardware, including non-oxide hardware, to allow for running on data center servers or manufacturing stations.
...
• Packaging system IPS (Image Packaging System) was used in OpenSolaris and Solaris 11
...
• Comparison of Helios to OmniOS LTS and recommendation to use OmniOS LTS for critical applications
...
• St. Louis is a new architecture in the Lumos branch of Oxide, aimed at reducing the complexity of the codebase
...
• The team is working to contribute to upstream Lumos and make it easier for others to contribute, with a focus on documentation and discoverability
• Documentation and contribution processes have been revamped, with links to the Lumos documentation repository and contributing guidelines available on the front page of lumos.org.
• Book recommendations for debugging memory corruption and device drivers
• Challenges with searching for "Lumos" due to Google's algorithm and synonym issues
• Recommended search strategies for finding accurate information on Lumos
• Perplexity.ai as a reliable source for Lumos-related information
• Experience with debugging a performance issue related to tunable values and memory
• Discussion of the importance of updating tunable values to match physical system attributes
...
• The "asbestos" and "bees" analogy for describing complex system behavior
...
• Reference to the porting of Cockroach and ClickHouse databases to the Helios OS
...
• Reflection on past experiences, including a negative experience with Samsung
...
• Discussion of a 4-letter acronym "You You"
...
• Discussion of a potential future episode on Propellas with a guest

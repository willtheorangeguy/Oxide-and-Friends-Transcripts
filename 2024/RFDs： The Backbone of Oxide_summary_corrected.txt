...
• Explanation of the PARC (Platform Software Architectural Review Committee) process at Sun Microsystems
• Recollections of the PARC process, including the development of materials for PARC cases and the value of writing down ideas
• Critique of the PARC process, describing it as bureaucratic and time-consuming, with approval or rejection rather than constructive feedback
• Comparison of the PARC process to a parole board, with senior engineers acting as gatekeepers of new ideas
...
• Discussion of RFD (Request for Discussion) process at Joint and how it was improved
• Experiences with RFDs at Joy ant, including difficulties with discussion and feedback
• Comparison of RFD process at Joint and at Delphi (including use of Google Docs)
...
• Pride and shame over the use of progenitor-generated CLI's

...
• The discussion touches on the concept of vtables and their role in implementing polymorphism.
...
• Automation of this solution using Cargo Hakari tooling
...
• Discussion of a problem with proc macros and build scripts causing inconsistent behavior in dev and prod builds
...
• Review of changes made to address the issue, including a speedup of 1.26x in common scenarios
...
• The discussion touches on the use of the Serde library and its potential limitations, as well as the trade-off between generality and performance.
...
• They also discuss the importance of understanding the costs and trade-offs of using certain tools and libraries, such as Serde.
...
• Experience with linker options, specifically LLD, LD, and Mold
• Comparison of linker performance on different operating systems
• Benefits of using Mold, including speed and multi-core utilization
...
• David Tolnej's proposal to compile proc macros into WASM and execute them to generate code
...
• Buck 2 is a build system written in Rust, similar to Bazel, and requires hermetic builds
...
• There is a graveyard of abandoned build systems, including Scons and WAF
...
• Analysis of various build systems, including Make, Bazel, Buck, and Excel (as a build system in its own right)
...
• Discussion of various build systems and tools (e.g. Cargo, Hakari, Excel)
...
• Hyperconverged infrastructure is not well understood and has a "goofy" term
...
• Discussion about fibre channel and its perceived "steampunk" quality
• Concerns about relying on third-party storage and vendor lock-in
• Experience with Delphi and its software virtual appliance for storage
...
• Visceral learning from using ZFS in production at Joint, including the impact of OS bugs on data corruption
...
• Consideration of alternative storage solutions, including Ref
• Evaluation of Ref's requirements for operators and staff
• Decision to prioritize autonomy and simplicity in the new design
• Comparison of Ref's journey and the need for a robust and reliable solution
• Conclusion that Ref is not a fit for the new storage service and a decision to build a simpler and more robust solution.
...
• Mention of Delphi's work along similar lines
• Discussion of "mix" approach, where ZFS would be on distributed nodes managing SSDs
• Explanation of Southern Volume Manager and Northern MIX approaches
...
• Joining of Alan in April 2021 and his background in storage at Sun, Three Par, and DSSD
...
• Joking about pet food names being used for data centres and the humour in it
...
• Removing unnecessary mutates and improving confidence in the system's safety
...
• Layering problem in disk storage and snapshooting
...
• Using ZFS for snapshooting and leveraging its guarantees
• Design decisions behind using a Pool on multiple SSDs
• Copy-on-write snapshooting features
• Leveraging ZFS snapshots to solve problems
• Using snapshooting mechanism to improve data management
...
• Shadow migration feature from Fish works appliance
• Hierarchical storage management and rekeying/migrating data format
• Using snapshooting to avoid downtime and upgrade software
...
• A discussion about a technical detail in the demo, specifically the difference between "read only parent colon arc guest" and "Dan block IO"
• The importance of recognizing and building on positive momentum in software development
• ZFS snapshots and writeable snapshots as a key feature of cloud-based infrastructure

• Bryan Can trill and Katie Missouri discuss their shared interest in cats with nerdy names
• Katie Missouri' cat, Scrappy, passed away in December
• Bryan Can trill's cat, Royal McGee, is named after a defunct computer company
...
• Katie Missouri is invited to share her perspective on the outage, which is seen as a complex and multifaceted issue
...
• The company was criticized for downplaying the gravity of the issue, saying it affected less than 1% of Windows devices, but Katie Missouri pointed out that this was a significant number and had far-reaching consequences.
• The vulnerability affected many critical systems, including those at airports, 911 call centres, and hospitals, causing widespread disruptions.
...
• The conversation also touched on the public's perception of Microsoft, with Katie Missouri saying that the company is often unfairly blamed for issues caused by third-party software.
...
• Economic damage to the software defect will be significant and quantifiable
...
• Past CSRB reports have been useful in highlighting best practices and areas for improvement in cybersecurity
...
• The SolarWinds attack was notable for being detected by Radiant, a cybersecurity company, but they themselves were compromised by the attackers for 4 months.
...
• Explanation of Heisenberg, which can change behaviour upon observation
• Analysis of the potential causes of the update's failure, including pointer to initialized memory
...
• Katie Missouri found a vulnerability in Clubhouse that allowed her to persist in an audio chat room without an avatar
• The vulnerability was disclosed to Clubhouse, which had a high valuation and a large bank balance, but only 5 employees
• Katie Missouri found the disclosure process to be frustrating and notes the lack of proportionality between Clubhouse's investment in security and its valuation
...
• Katie Missouri notes that vulnerabilities are often found in widely used software, such as open SSH, and that these vulnerabilities are not always addressed in a timely manner
...
• Difficulties in communicating complex ideas, such as Bryan's struggles to articulate his thoughts on Trace
...
• Katie Missouri's success in persuading big entities to invest in security and her strategies for making the case internally
...
• Katie Missouri's approach to convincing Microsoft to change their stance
...
• Being bootstrapped and profitable was a key factor in Active's success
...
• Limitations of the CSRB, including its reliance on industry members and lack of subpoena power
...
• Importance of careful labelling of incidents to avoid conspiracy theories
• CSRB's role and potential review of the incident
• Industry's reliance on research bodies and vulnerability detection
• Personal anecdotes from Katie Missouri about her experiences and family life

...
• Introduction of Josh Clulow and Robert, and mention of a potential surprise guest
• 10th anniversary of a past event, specifically a massive outage and rebooting of data centers
• Discussion of US East 1 and US West data centers and their importance
...
• Bryan Cantrill recounts how the team was able to quickly recover, despite some initial confusion and catatonia
...
• The origin of exit code 113 is discussed, with Bryan Cantrill mentioning that it's a controlled exit and they need to find out why it's 113.
• Josh Clulow suggests that the month is January, and Bryan mentions a specific date, January 13th, 2011, but later says it was a joke.
...
• Analysis of the system's configuration, including CPU and DRAM limitations, and how it affected the system's behavior
...
• NetXtreme 2 driver problems causing boot issues
• Personal anecdotes and humor about dealing with the issues
...
• Booter was "unleashed", allowing everything else to come up
...
• The team discussed how they were able to recover, including using the booter cache and tricking Manatee into one-on-right mode
...
• The consequences of false rumors and how they can affect people and organizations
...
• The specific changes made to the system, including:
	+ The default behavior of SSC on each node
...
• Bryan Cantrill's haircut and awkward meetings with Scott
...
• Improvements to node selection and validation to prevent destructive behavior
...
• Discussion about the limitations of JavaScript and its impact on software rigor
...
• Inband signaling and its issues

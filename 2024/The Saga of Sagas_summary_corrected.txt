...
• Joking about the concept of "Eventuating" (being right after previously being wrong)
• Introduction of Lure from Fukuyama, a reference to the TV show
• Explanation of the name "Omicron" and its Fukuyama origins
...
• Humour about mispronunciation of "Omicron" and other technical terms
• Challenges of evaluating outside work and adopting a "shrink to fit" model for journal clubs
• Discussion of Katie McCaffrey's work on distributed sagas and its impact on the team's understanding of transactionally in distributed systems
• Adam Levinthal's origin story of introducing the concept of distributed sagas to the team
...
• Stent framework in Rust for executing distributed saga
...
• Stent's log-based implementation and storage backend
• Nexus component incorporating Stent for saga execution
...
• The concept of sagas and their implementation in Stent
...
• A discussion on the importance of abstraction in Stent's design
...
• Discussion of recording state changes in the database and the potential for changing Stent's logging mechanism
...
• Reference to a "sub saga" in Stent and its use for handling multiple state changes

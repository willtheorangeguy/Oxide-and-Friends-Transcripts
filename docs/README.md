# Oxide and Friends Transcripts — Documentation

This archive holds machine-generated transcripts and summaries for the Oxide and Friends podcast episodes, together with the pipeline that produces them. The pipeline runs as 6 numbered stages; `main.py` executes them in order.

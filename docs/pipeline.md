# Oxide and Friends Transcripts — Pipeline
...
|---|---|---|---|
| 1 | `1_download.py` | This script uses yt-dlp to download audio, by year, from the Oxide and Friends podcast playlist. | — |
...
| 3 | `3_transcripts.py` | This script scrapes transcripts from transistor.fm for the Oxide and Friends podcast episodes. | `transcribed.log` |
| 4 | `4_transcriber.py` | This script transcribes audio files from the Oxide and Friends podcast episodes using OpenAI's Whisper model. | `transcribed.log` |
...
| `transcribed.log` | `3_transcripts.py` |

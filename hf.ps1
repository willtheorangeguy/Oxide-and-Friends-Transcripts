...
foreach ($Year in $YearFolders)
{
    ...
    $RepoId = "$Year-Oxide-and-Friends-Transcripts"
    $PrettyName = "$Year Oxide and Friends Transcripts"
...
# $PrettyName
Complete transcripts from the $Year episodes of the Oxide and Friends podcast.

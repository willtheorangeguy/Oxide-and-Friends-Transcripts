...
• Discussion of Bryan Can trill's one-year prediction about Intel's co-CEOs
• Analysis of a formal letter promoting a new CEO, highlighting its formal language and potential for humour
...
• The introduction of Click house added more complexity to the diffing process.
...
• The team is now exploring the use of a library called Diffuse, which provides semantic diffing capabilities.
...
• Introduction of the Diffuse crate and its use for semantic diffs
• Critique of Diffuse's aggressive approach and strange implementation details
...
• Mention of the "heterogeneous, three parsing problems" and Rain's recommended solution
• Discussion of the time and effort spent on using Diffuse and the eventual development of Daft
...
• Leafs are used in ends and other types to simplify diffing and make it more efficient
...
• Rain Pahari expands on Andrew's work, introducing the concept of "EQ" and making it optional for values
...
• The benefits of a library being "no standard" and not requiring any allocation, which allows for a more constrained and predictable behaviour
...
• Contributions to the no standard crates, including Rain Pahari's extensive work on error handling and proc macro development
...
• Rust Analyzer is unhappy with SYN's parsing behaviour

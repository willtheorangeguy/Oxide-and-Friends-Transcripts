...
• Mention of a "Morrell" electric shaver
...
• Comparison to Babel, a JavaScript transpired, and the Tower of Babel
• Pronunciation of a specific name (Doyen/Doyen)
...
• Rust Up's maintainer situation has changed over time, with Kirkman Schuman becoming involved in 2023
...
• Kirkman Schuman maintains several Rust projects, including Throne, Flame Graph, Indicative, and Russell's, and has contributed significantly to Rust up.
• He has a history of taking on maintenance of projects that were previously orphaned.
• Kirkman's contributions to Rust up have included refactoring, dependency upgrades, and improving performance.
• He has also replaced curl with request in Rust up, citing its Bash origins.
• The group discusses the safety and benefits of refactoring in Rust, with Bryan Can trill sharing his experience as a non-user of Rust analyzers.
• Kirkman and others discuss their experiences with code refactoring and maintenance, with a focus on Rust's safety features.
• The conversation turns to the specific changes and behaviour of Rust up, with the group discussing their approach to releasing new versions.
• Implicit behaviour of Rust Up installing a tool chain when a command is called
• Tension between making something approachable and rigorous
• NPM "isn't all" example of implicit behaviour and its implications
• Value divide between approachability and rigour
• Implicit installation of tool chains in Rust Up and its implications
• Discussion of the "rigour" side of the value divide and its relationship to the Rust community
• Comparison of Rust Up's behaviour to Git's ability to correct typos and its implications
• Changing the implicit behaviour of the Rust compiler to be more explicit
• Concerns about breaking binary compatibility and affecting users
• The difficulty of determining which users are implicitly relying on the old behaviour
...
• The potential for tool chain auditioning, where different components have different release schedules
• The importance of communication and community involvement in managing release schedules and change management
• The personal experience of Steve Flank and others with release schedules and community dynamics
...
• The Actin web situation was brought up as an example of how a toxic community can form, where the author of the project refused to accept feedback on their use of "unsafe" code.
...
• The speaker contrasted the Actin web situation with their own positive experience of receiving helpful feedback on their code, which they referred to as a "David Tone moment".
...
• Bryan Can trill's experience with being "busted" by a past mistake from 30 years ago
• Kirkman Schuman's efforts to communicate and address the feedback, including a roadmap for changes
• The change was effectively reverted, but an environment variable was left in place to adapt to the new behaviour
...
• Steve Flank's experience with the Rust project and his approach to criticizing it without making it personal
...
• Kirkman Schuman made the decision to revert the change after it was clear that it would break many users.
• The team relies on volunteers and maintainers to make important changes to foundational projects like Rust Up.
• The conversation highlighted the importance of maintainers and the need for robust foundations in open-source projects.
• Kirkman Schuman's handling of the crisis PR was praised by the team, who appreciated his listening and inclusive approach.
• Discussion of trust in a community or project
• Handling conflicts and negative feedback
• The importance of learning from experiences and other projects

...
• The conversation concludes with a mention of a past event where the speakers met Lars Bak, a Google engineer, to discuss the announcement of TypeScript in 2012.
• Development of TypeScript and its benefits, particularly in adding rigor and type safety to JavaScript
...
• Modularity and the need for tools like CommonJS to organize dependencies and improve performance
• Complexity of tooling due to lack of consensus on what a web app needs
• Vite and its role in solving bundling problems and improving tooling
...
• Utilizing OpenAPI spec to ensure correctness and conformity
• Using drop shot, a HTTP library that uses OpenAPI as an output
• Benefits of type checking across client-server boundary
• Maintaining a small team due to a strong API implementation
• Open sourcing oxide TS, a framework that generates an SDK and mock server framework from the OpenAPI spec

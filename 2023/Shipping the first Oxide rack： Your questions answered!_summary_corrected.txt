...
• Discussion of a supportive community on Hacker News and trolls comments
...
• Explanation of Oxide's target market, including companies moving from the cloud back to on-prem data centres
...
• Defence of the company's side quests (EE side quests) and their importance
• Discussion of building on commodity hardware vs. custom hardware
• Personal anecdotes from the speakers' experiences with hardware and software integration
...
• Value of having complete insight into system behaviour for optimal performance
• Difficulty in identifying workload power consumption due to complex system layers
• Inefficiency of data centre power usage, with up to 20% consumed by fan performance and cooling systems
...
• Fish works and Eclipse as companies that delivered integrated systems
...
• Experience with Smarts and Joint hypervisors
...
• Mention of the "screen cut" of Andy Jassy and Pat Gelsinger's conversation at reinvent
...
• Discussion of NVIDIA and its proprietary CUBA barrier
...
• Critique of VMware's motion feature and its perceived "black magic" nature
...
• Discussion of networking and cable backplate throughput
• Liquid cooling solutions and collaboration with Motivate
• Power budget and rack power consumption
• Use of Alamos and its features
• Controlling fate and intellectual property considerations
• Development of Trace and it's porting to other systems, including Linux
• Comparison of Trace to Linux's multiple solutions, which don't fully replicate its functionality
• Use of Trace in production with Allen and Crucible storage subsystem
• Discussion of BPF Trace and EPF, which doesn't solve the problem they need to solve
• Linux as an operating system kernel, requiring multiple decisions and integrations
• Maintaining LBC and its implications on the team
...
• Examples of the Linux community's lack of interest in contributed work, such as Detract and Rust
• The need for a platform that can provision virtual machines and the operating system, and the challenges of deplatforming exercises.
...
• The speaker reflects on their experience at Fish works and how it relates to their current challenges at Oxide.

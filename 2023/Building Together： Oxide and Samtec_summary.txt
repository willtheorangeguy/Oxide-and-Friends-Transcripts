...
• Oxide was initially looking for a supplier for a specific component, but ultimately found a partner in Samtech
• The challenge was to connect the QSFP ports to the ASIC, with a long PCB potentially causing signal integrity issues
• The flyover cable system from Semtech was identified as a solution to this problem, allowing for shorter cabling and improved performance
• Semtek solution was already available on their website
• Arjen and Jonathan had not heard of Semtek before
• They discovered the Semtek flyover design through a video on the website
• Jonathan was impressed by the design and contacted Semtek
• Samtech shipped a cable to Jonathan quickly and without requiring an NDA
• This was a unique experience compared to other companies they had contacted
• Samtech's approach is to support engineers and get them the parts they need to solve their problems
...
• Discussing a design approach that simplifies a switch design by not using a traditional backplane PCB
...
• The design of the flyover cables and pinout allows for future variations of the QSFP board, including support for QSFP-DD modules or other form factors.
...
• Initial consideration of Samtech was not primary, with plans to use it for flyover cables but seek another vendor for cable backplane
• A vendor was already being worked with, and attempts to transition them from vendor to partner were unsuccessful
• Delays in receiving drawings for backplane cables with XMX connectors
...
• Initial reluctance to switch to SamTuck due to concerns about time and potential for pitting companies against each other
• Jonathan's involvement led to SamTuck catching up and eventually delivering drawings before the other vendor
• Frustration with the original vendor due to slow response times and difficulty in communication
• Benefits of working with SamTuck, including a smaller number of involved people and efficient communication
...
• TwinX cable construction and importance of bending center conductors together
...
• Discussion of collaboration between Samtech and Benchmark to resolve the issue
...
• Traveling to a manufacturing facility for a short period is not feasible due to extra overhead and strain on the team.
...
• Discussion about Jignesh's role as a technologist and his involvement in detailed conversations
• Importance of understanding the mechanical and electrical aspects of cabled backplanes
...
• Discussion about the limitations of PCB material for backplane design and the need for a cabled solution
• Mention of considering a fiber optic link as a future option
...
• Integrated photonics on the chiplet or package can potentially change the power consumption equation.
...
• Next-generation cables (Twinax Air) have a dielectric with air voids, reducing loss by 20%
• This reduction in loss has significant ramifications for power and signal integrity
• As receivers improve, they become more complex and require more silicon, driving the need for chiplets
...
• Pairing longest cables with shortest traces on print circuit boards to conserve margin
• Hesitation to consider 112 gig link due to lack of modeling
...
• Discussion on chiplets and photonics technology integration challenges
...
• Need for switching silicon, potentially through partnership with Samtac
• Comparison of DNA (company culture) between Samtac and another company (Oxide)
• Partnership between these two companies and their potential for collaboration
• Discussion of co-packaged photonics and partnerships with major chip makers

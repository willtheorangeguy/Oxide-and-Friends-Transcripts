...
• The guest operating system's expectations of the TSC are discussed, including its behaviour on boot and frequency stability.
...
• Clap's ease of use and ability to churn out programs with reasonable behaviour
• Integration of Struct opt directives into Clap
...
• Use of Clap in a project to create a simulator that mimics guest behaviour on multiple machines
...
• Distinguishing between Beehive (in-kernel VMM) and Propelled (user-space component)
• Discussing the design of Propelled and its goals of running big VMs with full features

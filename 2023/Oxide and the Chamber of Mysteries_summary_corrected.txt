...
• Circumventing EMC compliance in data centres, specifically the approach taken by Facebook
• Site testing and measurement of emissions in data centres
• Comparison of regulatory approaches between the US and Europe
• Historical examples of interference and its consequences (e.g. USS Forestal, blender-TV interference)
• Importance of EMC compliance for preventing hazardous behaviour in electronic devices
...
• Discussing a test report from Murat that seemed suspicious
• Evaluating test reports from various test houses, including TUV, Internet, and UL
...
• Mention of the compliance being cancelled due to the test failure
...
• They are having 14 components decamped to understand the damage.
...
• Debugging issues with SSC on specific components (Shark Vid issue)
...
• Understanding the behaviour of individual systems and how they combine, with some components requiring physical work to test
...
• Changes made to pass safety compliance, including grounding and marketing modifications
...
• Praise for team members, including Steve and Matt Keeper
...
• Manufacturing station has a similar interface, built by Josh Could
• Wicket allows configuration of the system and talks to a downstream service called WILD
...
• Possibility of building a normal captive CLI, similar to Deadline, was mentioned
...
• The Wicket system is built using an event loop and global state, with messages being totally ordered and serialized for replay.
...
• The speaker built a debugger for a previous project at VMware, but it was cancelled
...
• Discussion of Serve, a serialization and deserialization library in Rust
• Benefits of using Serve, including its ability to generate serialization and deserialization code automatically
• Explanation of procedural macros and how Serve uses them to generate code
• Overview of the SERIES visitor pattern and pluggable serialization formats
• Use case of Serve in a Wix it project, where it was used to serialize and deserialize events
...
• It involves writing a "property" that defines a specific behaviour, such as "reversing a list twice results in the original list"
...
• The Protest crate and Quick Check from Haskell are examples of property-based testing tools.
• Protest and Quick Check compared and contrasted
• Protest's advantages over Quick Check, including its ability to derive and compose types and generate new outputs
• Protest's features and tools, including an introductory book and a focus on coherence
• Recommendation to use Protest for testing and debugging
...
• Travelling to Belgium in 2003 and attempting to find horse meat
...
• Next week's topic will be the cable backplate, with guests including a mechanical engineer and an engineer from NewTek.
• The discussion will cover a mishap with the cable backplate and how it was debugged.
...
• Discussion of OpenPnP software and its use with the pick and place machine
...
• The team has learned from past experiences, such as the development of the Gemini board, which was too highly integrated and difficult to prototype.
...
• The Gemini board served as an educational experience for the team, highlighting the importance of modularity and iterability.
• The conversation discusses the challenges of the electronic supply chain disruption, specifically with regards to obtaining connectors and ICs.
...
• The Spymux board was designed to prototype a multiplexer circuit for sharing a flash part between an ARM processor and an AMD processor.
• The board was also used to test and understand the analog challenges of sharing a QSPY/QuadSPY Flash part.
...
• The Spymux board was built in-house using KiCad and allowed the designers to test and understand the circuit's behavior.
• The board was able to switch between the ARM and AMD processors at 33 MHz and could boot the x86 machine through the mux.
• The Spymux board saved the team a significant amount of time and effort by allowing them to test and validate the circuit before moving to a full board spin.
• The Gimlet Let board was mentioned as a later design that benefited from the knowledge gained from the Spymux board.
...
• The board is connected to various devices and boards, including the Renaissance power eval boards and the 100 amp demo board from LTC.
...
• Introducing the Dimlet board and its purpose
• Discussing the genesis of the Dimlet board and its role in solving a specific problem
...
• Use of DDR 4 DIMMs on a custom circuit with only 10 pins soldered, and the rest for mechanical stability
...
• Design of the gimbal and its regulators
• Breakout boards and adapters for Samtech connectors
...
• Discussion of various components and tools, including Saleae A too and SurCap
• Discussion of the GIMLET hardware and its various components, including the ICE 40 FPGA and PMOD connectors
• Explanation of the ignition network and its role in power control
• Show and tell of various GIMLET-related boards and hardware, including the GIMLET carrier carrier and the VSC 7448 network switch dev kit
...
• Adafruit's IDC cables for smaller pin count
...
• Explanation of the Klugeot 2 and its functionality
...
• Explanation of the Dongwet board and its functionality
• Discussion of the VPD board and its interface with the Dongwet board
• Explanation of the need for a new board (Donglet) due to shortage of original processor
• Discussion of the features of the Donglet board, including a regulator, USB connector, and SPI connector.
...
• Customization of off-the-shelf components for testing (e.g. QSFP loopback module)
...
• Refinement of the KludgeShot 2 design with improved mechanical and electrical components
• Development of the Kloochart 2 and its features
• Benefits of having Ethernet ports and IO interfaces on the manufacturing line
• Discussion of the "Swiss army knife effect" of the Gimme Whitlet

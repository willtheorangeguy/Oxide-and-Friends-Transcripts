...
• The discussion centers around the hype and excitement surrounding unikernels in 2016, which is referred to as "peak Docker" by Speaker 1.
...
• The conversation also touches on the idea that some advocates of unikernels may undermine their own cause by not thinking critically and nuancely about the issues at hand.
• Discussion of abstractions in computing, with the idea that some abstractions may be flawed or unnecessary
• Mention of the "exokernel" concept, which proposes that applications should handle their own low-level details
• Critique of the exokernel idea, with speakers arguing that it would be difficult to debug and maintain
...
• Reference to a recent decision to use a specific kernel or API instead of a different one, and the question of whether this represents a missed opportunity to rethink and simplify existing abstractions.
• POSIX and WebAssembly integration challenges
• Difficulty implementing unikernels in practice
• Exokernel vs unikernel conceptual differences
...
• Discussion of specific tools and technologies, such as CoreSite and ETB, and how they are not being used
...
• Discussion of MISRA and its limitations in being adapted to Rust.
...
• Complexity in systems and emergent behavior

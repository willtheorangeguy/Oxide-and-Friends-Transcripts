...
Oxide and Friends Podcast Transcripts GitHub repository. 
"""
import os
import zipfile
import requests
...
def unzip_file(zip_path):
    ...
    extracted_folder = os.path.join(cwd, "Oxide-and-Friends-Transcripts-main")
    if os.path.exists(extracted_folder):
        new_folder_name = "Oxide-and-Friends-Transcripts"
...
if __name__ == "__main__":
    ...
    url = "https://github.com/willtheorangeguy/Oxide-and-Friends-Transcripts/archive/refs/heads/main.zip"
    output_zip = "oxide_and_friends_transcripts.zip"

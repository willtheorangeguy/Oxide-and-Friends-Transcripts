...
• Node and Joy ant's divorce and its impact on the speaker's values and goals
...
• The challenges of working with Open Titan and the need for a secure and reliable root of trust
...
• The reaction of Liquid, who wrote L3 and L4, and his inspiration for L4
• The influence of Liquid's work on Hubris and its IPC mechanism
• The avoidance of labelling Hubris as a microkernel due to potential negativity
...
• IT (instrumentation trace macro cell): faster, but lossy
...
• Data-bearing ends in Rust and their use in debugging and logging
...
• A common modelling language or system is mentioned as a possible approach to co-design, but its limitations are acknowledged, specifically the difficulty of machines to make intuitive leaps.

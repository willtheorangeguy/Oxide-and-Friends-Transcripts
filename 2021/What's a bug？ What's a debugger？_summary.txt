...
• The speaker reflects on their past experiences with debugging, including writing their first debugger as an undergraduate
...
• The speaker reflects on how their past experiences have influenced their current approach to debugging and understanding software systems
...
• The conversation also touches on the definition of a debugger and the speaker's complicated feelings about LibDisc.
• The idea of LibDisc, which interprets binary instructions in a structural form to aid in understanding and manipulating program components.
• Comparison to Ghidra and other reverse engineering tools, and the potential for more crossover with debugging tools.
• Discussion of the LPC35 vulnerability and its connection to reverse engineering.
• The concept of debugging and whether or not LibDisc is considered a debugger.
...
• The speaker touches on the idea that observability is not just a mathematical property, but also about being able to see and understand the behavior of a system
...
• Differentiating between performance and unexpected behavior as bugs.
• Importance of visibility tools in addressing complex bugs.
• Role of CICD and unit testing in addressing bugs and ensuring production quality.
• Disconnection between advancements in CICD and unit testing and the need for better debugging tools.
...
• The difficulty of diagnosing complex memory errors and the potential benefits of identifying neighboring memory allocations.
...
• Describing the process of propagating types through the system and determining the type of a memory object
• Comparing the ease of use and effectiveness of debuggers versus print statements (e.g. Printf)
...
• The importance of Printf debugging for quick and effective problem-solving
• Criticism of a professor's approach to teaching students to use a debugger over Printf debugging
• Comparison of Printf debugging with using a debugger, with the latter being more powerful but requiring more setup and knowledge
• The human UX aspect of why people reach for Printf debugging before using a debugger
...
• Discussion of printf debugging and its limitations
...
• CICD and test-driven development practices
...
• Discussion about the name change of the software from Parrot/Pearl Six to Roku/Raku
...
• Discussion of the importance of understanding system behavior and performance

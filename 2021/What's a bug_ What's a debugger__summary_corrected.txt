...
• Discussion of the concept of "trace" and its limitations
...
• The use of TNF (Trace Normal Form) and other debugging tools can be challenging and may not always reveal the true behaviour of a system
...
• There is a need for more scriptable and automated debugging tools that can handle complex systems and dynamic behaviour.
• Discussion of a tool that interprets binary code in a structural form to help humans understand program behaviour
• Comparison of the tool to Hydra, a reverse engineering platform
• Vulnerability discovery using the tool and Hydra
• Debate on the term "debugger" and its connotations
• Discussion of observability and its relationship to understanding software behaviour
...
• Issue with Trace and incorrect output
...
• Discussion around the definition of a bug, specifically focusing on the difference between performance issues and unexpected behaviour
• Tooling and visibility into system behaviour, particularly with Trace, to identify and address issues
• The importance of understanding system behaviour, especially in modern development environments where unit tests and CCD are prevalent
• The idea that the absence of understanding system behaviour has driven the need for more comprehensive testing and development practices
• The suggestion that traditional debuggers are no longer necessary in the age of testing and CCD
...
• The value of print/print-style debugging for simple issues and the need for a balanced approach to debugging tools
...
• The issue of people reaching for print and logging style debugging before actual debuggers
...
• Observability and software observability efforts (e.g. Open Tracing)
• Impact of CCD and testing on debugging and infrastructure
• Dynamic languages and their limitations in dynamic instrumentation
• The past and present of the Parrot/Perl 6/Baku language and its debugging

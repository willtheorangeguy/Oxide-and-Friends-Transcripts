...
• He shares an experience where he was mistaken for Adam Levinthal, a British sportscaster, and received replies from him.
• Adam and Brian discuss the humorous side of being mistaken for each other and how it's a reasonable confusion.
• The speaker's favourite team is the Checkers, who are based in Nashville
...
• Lib watch Malice and its problems
...
• Mentioning the replacement of P trace by /proc in Unix and its use on Linux for system information
• Discussing the pain of using Pete trace for debugging, particularly in regard to the weight system call
...
• Legacy system's reliance on Trace
• History of Trace and its documentation
...
• Reference to Petra's and the difficulties of implementing certain features
...
• Application core dumped due to reliance on implicit behaviour (phishing in its own stack)
...
• Discussing running Illumes on M1 (ARM CPU)
...
• Discussion of a stolen laptop, specifically a power PC laptop running Polaris 251
...
• Upgrade to app, mentioning its impressive that it didn't crash
...
• The speaker has experience with D-Trace and finds it somewhat ergonomic compared to SQL or Finical
...
• Luck is mentioned as a design principle, but also as a pejorative term in the context of programming languages
• The speaker notes that Luck was originally intended as a pragmatic approach, but is now viewed as a criticism by some in the PL community
• The speaker contrasts Luck with the D language, which is described as more structured and less fussy, but also notes that D is not immune to criticism
...
• Mention of Detract and its relation to the current project
• Comparison of the development time of Detract to the current project
...
• Mention of CUBA, NVIDIA, and GP GPU
...
• Rust's macro system is being utilized by various efforts, including NVIDIA's coast expert work
...
• Controlling the compiler's behaviour and output
...
• Mention of trace and its relevance to the discussion
• Desire to demonstrate analytics and viewership data to support a claim about Fork
...
• Discussion of Stack captures and backtrack features missing in D Trace
